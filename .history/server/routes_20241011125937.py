...
def register_routes(app, db):
    ...
    @app.route('/api/get_events_to_delete', methods=['GET'])
    def get_events_to_delete():
        # Fetch events that are not completed
        events_list = events.query.filter_by(completed=False).all()
    ...
    @app.route('/api/delete_event/<int:eventid>', methods=['DELETE'])
