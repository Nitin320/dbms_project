    ...
    def create_event():
        try:
            ...
            new_event = events(
                ...
                completed=0  # Event is not completed
            )
            ...
            return jsonify({
                ...
                "event_id": new_event.eventid  # Return the new event ID
            }), 201
        except IntegrityError as e:
            db.session.rollback()  # Rollback the session in case of error
            return jsonify({"error": str(e)}), 400
        except Exception as e:
            db.session.rollback()  # Rollback the session in case of unexpected errors
